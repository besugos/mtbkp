$(document).ready(function() {
	...
	$(document).on('change', '#product_address_attributes_state_id', function(){
		var state_id = $(this).find(":selected").val();
		var select_to_populate = '#product_address_attributes_city_id';
		find_by_state(state_id, select_to_populate);
	});

	$(document).on('blur', '#product_address_attributes_zipcode', function(){
		let cep = $(this).val();
		find_by_cep(cep, 'product_address_attributes_address', 
			'product_address_attributes_district', 
			'product_address_attributes_state_id', 
			'product_address_attributes_city_id');
	});

	$(document).on('change', '#service_address_attributes_state_id', function(){
		var state_id = $(this).find(":selected").val();
		var select_to_populate = '#service_address_attributes_city_id';
		find_by_state(state_id, select_to_populate);
	});

	$(document).on('blur', '#service_address_attributes_zipcode', function(){
		let cep = $(this).val();
		find_by_cep(cep, 'service_address_attributes_address', 
			'service_address_attributes_district', 
			'service_address_attributes_state_id', 
			'service_address_attributes_city_id');
	});

	$(document).on('change', '#user_data_professional_attributes_address_attributes_state_id', function(){
		var state_id = $(this).find(":selected").val();
		var select_to_populate = '#user_data_professional_attributes_address_attributes_city_id';
		find_by_state(state_id, select_to_populate);
	});

	$(document).on('blur', '#user_data_professional_attributes_address_attributes_zipcode', function(){
		let cep = $(this).val();
		find_by_cep(cep, 'user_data_professional_attributes_address_attributes_address', 
			'user_data_professional_attributes_address_attributes_district', 
			'user_data_professional_attributes_address_attributes_state_id', 
