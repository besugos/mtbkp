class Address < ActiveRecord::Base
	...
	attr_accessor :complete_address, :city_name, :state_name, :remove_validate, :validate_to_order, :page_title, :skip_validate
	...
	belongs_to :address_area

	validates_presence_of :zipcode, :address, :district, :number, :state_id, :city_id, if: Proc.new { |object| object.skip_validate != true }
	...
	def default_values
		...
		self.complement ||= ''
		self.reference ||= ''
		self.address_area_id ||= AddressArea::GENERAL_ID
	end
